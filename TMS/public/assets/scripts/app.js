...
var App = function () {
    ...
    return {
        ...
        // wrapper function to  block element(indicate loading) Modified by Nijil to use the UIblock library
        initblockUI: function (options) {
            if(!options)
                msg = '<h4>Processing please wait...&nbsp;&nbsp;&nbsp;&nbsp;<i style="font-size:28px" class="fa fa-cog fa-spin"></i></h4>';  
            else
                msg = options.message;
            $.blockUI({ 
              message: msg,
